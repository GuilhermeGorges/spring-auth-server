...
import com.guilherme.example.auth.user.domain.UserRepository;
import com.guilherme.example.auth.user.security.CanEditMyUser;
import com.guilherme.example.auth.user.security.CanReadMyUser;
