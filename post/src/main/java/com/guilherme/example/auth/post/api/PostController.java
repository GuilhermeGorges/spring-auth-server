...
import com.guilherme.example.auth.post.client.UserReactiveClient;
import com.guilherme.example.auth.post.domain.Post;
import com.guilherme.example.auth.post.domain.PostRepository;
import com.guilherme.example.auth.post.security.CanWritePosts;
import com.guilherme.example.auth.post.security.SecurityService;
